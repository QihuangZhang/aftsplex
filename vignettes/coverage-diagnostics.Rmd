---
title: "Coverage diagnostics: bootstrap SE versus empirical SE"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Coverage diagnostics: bootstrap SE versus empirical SE}
...
curve attains empirical coverage around 85% on the simulated diminishing-
returns curve --- short of the nominal 95%. This vignette reproduces the
diagnostic from the manuscript appendix that pinpoints the cause: the
bootstrap recovers the sampling variance honestly, and the coverage gap
is bias-centering, not variance-underestimation.
...
For each grid point, the bootstrap CI width implies a normal-approximation
SE of `width / (2 * 1.96)`. The empirical SE is the Monte Carlo SD of the
single-fit `f_hat` across replicates.
